...
as well as from the Notebook Aspect. ~This should be a focus of
usability work on PyVO and on possible ``convenience'' wrapper functions
between now and ComCam operation.
